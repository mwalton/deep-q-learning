...
if __name__=='__main__':
    ...
    x_shape = (FLAGS.batch_size, FLAGS.image_size * FLAGS.image_size)
    y_shape = (FLAGS.batch_size, FLAGS.num_classes)
    ...
    x_image = tf.reshape(x, [FLAGS.batch_size,FLAGS.image_size, FLAGS.image_size, FLAGS.num_channels])
